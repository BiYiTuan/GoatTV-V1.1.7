...
.method protected declared-synchronized getMagic(J)J
    ...
    :try_start_3
    const-string v0, "Got exception checking file magic: "

    invoke-static {v0, v6}, Lio/vov/vitamio/utils/Log;->e(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_3
    ...
    :try_start_5
    const-string v0, "Got exception when reading magic, id = %d, disk full or mount read-only? %s"
...
.method protected declared-synchronized getMiniThumbFromFile(J[B)[B
    ...
    invoke-virtual {v0, p3, v3, v7}, Ljava/nio/ByteBuffer;->get([BII)Ljava/nio/ByteBuffer;
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_1
    ...
    .local v6, "ex":Ljava/io/IOException;
    :try_start_3
    const-string v0, "got exception when reading thumbnail id = %d, exception: %s"
    ...
    .local v6, "ex":Ljava/lang/RuntimeException;
    :try_start_5
    const-string v0, "Got exception when reading thumbnail, id = %d, disk full or mount read-only? %s"
...
.method protected declared-synchronized saveMiniThumbToFile([BJJ)V
    ...
    .local v6, "ex":Ljava/io/IOException;
    :try_start_5
    const-string v0, "couldn\'t save mini thumbnail data for %d; %s"
    ...
    .local v6, "ex":Ljava/lang/RuntimeException;
    :try_start_8
    const-string v0, "couldn\'t save mini thumbnail data for %d, disk full or mount read-only? %s"
