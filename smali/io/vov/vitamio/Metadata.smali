...
.method public parse(Ljava/util/Map;Ljava/lang/String;)Z
    ...
    .line 132
    const-string v4, "Vitamio[Metadata]"
    ...
    invoke-virtual {p0, v9}, Lio/vov/vitamio/Metadata;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, v10}, Lio/vov/vitamio/Metadata;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, v11}, Lio/vov/vitamio/Metadata;->getString(I)Ljava/lang/String;
    ...
    invoke-virtual {p0, v6}, Lio/vov/vitamio/Metadata;->getLong(I)J
    ...
    invoke-virtual {p0, v6}, Lio/vov/vitamio/Metadata;->getInt(I)I
    ...
    const-string v6, "audio_bit_rate:\t"
    ...
    const-string v6, "audio_sample_rate:\t"
    ...
    invoke-virtual {p0, v6}, Lio/vov/vitamio/Metadata;->getDouble(I)D
    ...
    const-string v6, "cap_pause:\t\t"

    invoke-direct {v5, v6}, Ljava/lang/StringBuilder;-><init>(Ljava/lang/String;)V

    const/16 v6, 0x1d

    invoke-virtual {p0, v6}, Lio/vov/vitamio/Metadata;->getBoolean(I)Z
