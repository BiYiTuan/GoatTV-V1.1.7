...
.method private endFile(Lio/vov/vitamio/MediaScanner$FileCacheEntry;)Landroid/net/Uri;
    ...
    invoke-static {v9}, Lio/vov/vitamio/MediaScanner;->access$3(Lio/vov/vitamio/MediaScanner;)Landroid/content/ContentProviderClient;
    ...
    # getter for: Lio/vov/vitamio/MediaScanner;->mProvider:Landroid/content/ContentProviderClient;
    invoke-static {v10}, Lio/vov/vitamio/MediaScanner;->access$3(Lio/vov/vitamio/MediaScanner;)Landroid/content/ContentProviderClient;
...
.method public addNoMediaFolder(Ljava/lang/String;)V
    ...
    # getter for: Lio/vov/vitamio/MediaScanner;->mProvider:Landroid/content/ContentProviderClient;
    invoke-static {v3}, Lio/vov/vitamio/MediaScanner;->access$3(Lio/vov/vitamio/MediaScanner;)Landroid/content/ContentProviderClient;
...
.method public beginFile(Ljava/lang/String;JJ)Lio/vov/vitamio/MediaScanner$FileCacheEntry;
    ...
    .line 265
    .local v14, "mediaFileType":Lio/vov/vitamio/MediaFile$MediaFileType;
    if-eqz v14, :cond_6

    .line 266
    iget v3, v14, Lio/vov/vitamio/MediaFile$MediaFileType;->fileType:I

    iput v3, p0, Lio/vov/vitamio/MediaScanner$MyMediaScannerClient;->mFileType:I

    .line 267
    iget-object v3, v14, Lio/vov/vitamio/MediaFile$MediaFileType;->mimeType:Ljava/lang/String;

    iput-object v3, p0, Lio/vov/vitamio/MediaScanner$MyMediaScannerClient;->mMimeType:Ljava/lang/String;
    ...
    invoke-static {v3}, Lio/vov/vitamio/utils/FileUtils;->getCanonical(Ljava/io/File;)Ljava/lang/String;
    ...
    invoke-static {v3}, Lio/vov/vitamio/MediaScanner;->access$0(Lio/vov/vitamio/MediaScanner;)Z
    ...
    invoke-static {v3}, Lio/vov/vitamio/MediaScanner;->access$1(Lio/vov/vitamio/MediaScanner;)Ljava/util/HashMap;
    ...
    check-cast v2, Lio/vov/vitamio/MediaScanner$FileCacheEntry;

    .line 274
    .local v2, "entry":Lio/vov/vitamio/MediaScanner$FileCacheEntry;
    if-nez v2, :cond_8

    .line 275
    new-instance v2, Lio/vov/vitamio/MediaScanner$FileCacheEntry;

    .end local v2    # "entry":Lio/vov/vitamio/MediaScanner$FileCacheEntry;
    const/4 v3, 0x0
    ...
    invoke-direct/range {v2 .. v8}, Lio/vov/vitamio/MediaScanner$FileCacheEntry;-><init>(Landroid/net/Uri;JLjava/lang/String;J)V

    .line 276
    .restart local v2    # "entry":Lio/vov/vitamio/MediaScanner$FileCacheEntry;
    iget-object v3, p0, Lio/vov/vitamio/MediaScanner$MyMediaScannerClient;->this$0:Lio/vov/vitamio/MediaScanner;
    ...
    iput-boolean v3, v2, Lio/vov/vitamio/MediaScanner$FileCacheEntry;->mSeenInFileSystem:Z

    .line 280
    iget-wide v3, v2, Lio/vov/vitamio/MediaScanner$FileCacheEntry;->mLastModified:J
    ...
    iput-wide v0, v2, Lio/vov/vitamio/MediaScanner$FileCacheEntry;->mLastModified:J

    .line 283
    const/4 v3, 0x1

    iput-boolean v3, v2, Lio/vov/vitamio/MediaScanner$FileCacheEntry;->mLastModifiedChanged:Z

    .line 286
    :cond_a
    move-object/from16 v0, p1

    iput-object v0, p0, Lio/vov/vitamio/MediaScanner$MyMediaScannerClient;->mPath:Ljava/lang/String;

    .line 287
    move-wide/from16 v0, p2

    iput-wide v0, p0, Lio/vov/vitamio/MediaScanner$MyMediaScannerClient;->mLastModified:J

    .line 288
    move-wide/from16 v0, p4

    iput-wide v0, p0, Lio/vov/vitamio/MediaScanner$MyMediaScannerClient;->mFileSize:J

    .line 289
    const/4 v3, 0x0

    iput-object v3, p0, Lio/vov/vitamio/MediaScanner$MyMediaScannerClient;->mTitle:Ljava/lang/String;

    .line 290
    const-wide/16 v3, 0x0

    iput-wide v3, p0, Lio/vov/vitamio/MediaScanner$MyMediaScannerClient;->mDuration:J
...
.method public doScanFile(Ljava/lang/String;JJZ)Landroid/net/Uri;
    ...
    invoke-static {v3, p1, v4}, Lio/vov/vitamio/MediaScanner;->access$2(Lio/vov/vitamio/MediaScanner;Ljava/lang/String;Ljava/lang/String;)Z
