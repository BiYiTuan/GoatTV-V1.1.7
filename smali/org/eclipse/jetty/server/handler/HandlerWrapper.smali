...
.method public getNestedHandlerByClass(Ljava/lang/Class;)Lorg/eclipse/jetty/server/Handler;
    ...
    .prologue
    .line 148
    .local p1, "byclass":Ljava/lang/Class;, "Ljava/lang/Class<TH;>;"
    move-object v0, p0

    .line 149
    .local v0, "h":Lorg/eclipse/jetty/server/handler/HandlerWrapper;
    :goto_0
    if-eqz v0, :cond_1
    ...
    .line 158
    .end local v0    # "h":Lorg/eclipse/jetty/server/handler/HandlerWrapper;
    :goto_1
    return-object v0

    .line 153
    .restart local v0    # "h":Lorg/eclipse/jetty/server/handler/HandlerWrapper;
    :cond_0
    ...
    .line 154
    .local v1, "w":Lorg/eclipse/jetty/server/Handler;
    instance-of v2, v1, Lorg/eclipse/jetty/server/handler/HandlerWrapper;
    ...
    .line 158
    .end local v1    # "w":Lorg/eclipse/jetty/server/Handler;
    :cond_1
    const/4 v0, 0x0
...
.method public setHandler(Lorg/eclipse/jetty/server/Handler;)V
    ...
    .line 74
    .local v0, "old_handler":Lorg/eclipse/jetty/server/Handler;
...
.method public setServer(Lorg/eclipse/jetty/server/Server;)V
    ...
    iget-object v4, p0, Lorg/eclipse/jetty/server/handler/HandlerWrapper;->_handler:Lorg/eclipse/jetty/server/Handler;
